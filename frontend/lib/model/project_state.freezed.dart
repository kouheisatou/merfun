...
class _$ProjectStateImpl implements _ProjectState {
  const _$ProjectStateImpl({this.title = 0, this.image = 0});
  ...
  @override
  String toString() {
    return 'ProjectState(title: $title, image: $image)';
  }
...
abstract class _ProjectState implements ProjectState {
  const factory _ProjectState({final String title, final String image}) =
      _$ProjectStateImpl;
